    ...
    while(1):
        ...
        if(difHandT == 3):
            ...
            if(gamePrize - countFlip > 0):
                ...
                if(countWin == 1):
                    plt.hist(listwinningprize, color = "green", alpha=0.75, label='Wins')
                    plt.legend()
                else:
                    plt.hist(listwinningprize, color = "green", alpha=0.75)
                ...
                if(countLose == 1):
                    plt.hist(listlossinggprize, color = "red", alpha=0.75, label='Losses')
                    plt.legend()
                else:
                    plt.hist(listlossinggprize, color = "red", alpha=0.75)
...
max1 = max(listwinningprize)
max2 = max(listlossinggprize)
max = max(max1,max2)
