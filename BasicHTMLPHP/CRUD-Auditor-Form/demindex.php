...
<head>
    ...
    <title>CRUD Operations Auditors</title>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th colspan="2">
                            <input type="text" class="form-control" id="ac_no" name="ac_no" placeholder="Input Box" value="<?php echo htmlspecialchars($ac_no); ?>" required>
                        </th>
                        <th colspan="1">
                        ...
                        <th colspan="1">
                        <button type="button" class="btn btn-dark" name="action" value="view" onclick="setRequired('view')" style="width: 100%; border-radius:0;">View Table</button>
                        </th>
                    </tr>
                </thead>
                <thead>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewResultsModalLabel">Table Results</h5>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (action === 'submit') {
                ...
                var searchResults = JSON.parse(decodeURIComponent(urlParams.get('view_table')));
