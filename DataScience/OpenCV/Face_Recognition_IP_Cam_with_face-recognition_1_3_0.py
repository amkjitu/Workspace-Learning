...
known_face_names, known_face_encodings = load_images_from_folder_and_recognize(
    "./DataScience/OpenCV/CSE-15-Final/"
)
...
video_capture = cv2.VideoCapture(
    "rtsp://admin:L200461B@192.168.0.182:554/cam/realmonitor?channel=1&subtype=0"
)
...
while True:
    ...
    for (top, right, bottom, left), name in zip(face_locations, face_names):
        ...
        cv2.rectangle(
            frame, (left, bottom - 25), (right, bottom), (255, 0, 0), cv2.FILLED
        )
