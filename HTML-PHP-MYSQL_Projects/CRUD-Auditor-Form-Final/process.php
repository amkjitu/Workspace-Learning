...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Database connection for infinity hosting
    // $servername = "sql205.infinityfree.com";
    // $username = "if0_36915065";
    // $password = "simplecrud1234";
    // $dbname = "if0_36915065_auditors";
    ...
    if ($action == 'submit') {
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            header("Location: index.php?action=duplicateData&ac_no={$data['ac_no']}");
        }
        ...
        if ($result->num_rows > 0) {
            ...
            header("Location: index.php?action=view&view_table=" . urlencode($view_table));
        } else {
            header("Location: index.php?action=noData");
        }
    }
